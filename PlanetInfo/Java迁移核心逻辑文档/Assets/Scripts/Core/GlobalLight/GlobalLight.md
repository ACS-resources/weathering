# GlobalLight.cs（Java 迁移解构文档）

- 源文件：`Assets/Scripts/Core/GlobalLight/GlobalLight.cs`
- 命名空间：`Weathering`
- 代码行数：`80`
...
- `class GlobalLight`：建议在 Java 中映射为同名（或语义等价）类型，并保留可见性与职责边界。

## 3. 函数/属性接口梳理

### 3.1 方法签名

- `public Decorated(string name)`
- `public SyncCharacterLightPosition(Material mat)`
- `private Awake()`

### 3.2 属性签名

- `public Ins`
- `public UseDayNightCycle`
- `public UseCharacterLight`
- `public StarLightRotation`
- `public StarLightIntensity`
- `public StarLightColor`
- `public StarLightPosition`
- `public CharacterLightPosition`
- `public CharacterLightIntensity`
