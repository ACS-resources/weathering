# TextMultiLine.cs（Java 迁移解构文档）

- 源文件：`Assets/Scripts/Core/UI/Component/TextMultiLine.cs`
- 命名空间：`Weathering`
- 代码行数：`13`
...
- `class TextMultiLine`：建议在 Java 中映射为同名（或语义等价）类型，并保留可见性与职责边界。
...
{
	public class TextMultiLine : MonoBehaviour
	{
